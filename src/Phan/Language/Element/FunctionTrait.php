...
trait FunctionTrait
{
     ...
     * 3) The setting `override_return_types` or `track_all_inferred_types` is enabled and the method has no
     *      hardcoded or dependent return type.
     */
    public function isReturnTypeModifiable(): bool
    {
        ...
        if (Config::getValue('override_return_types') || Config::getValue('track_all_inferred_types')) {
